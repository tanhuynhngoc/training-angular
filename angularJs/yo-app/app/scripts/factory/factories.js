...
// retrieve tickets from Firebse database
.factory( 'Tickets', [ 'fbURL', '$firebaseArray', function ( fbURL, $firebaseArray ) {
...
// Store and queue flash messages used on save ad create
...
.factory( 'WcagscService', function () {
	return {
		"wcagSCList": [
			{
				'value': '1.1',
				'criterion': '1.1   Provide text alternatives for any non-text content'
			},
			{
				'value': '1.1.1',
			...
			{
				'value': '1.2',
				'criterion': '1.2   Provide alternatives for time-based media'
			},
			{
				'value': '1.2.1',
			...
			{
				'value': '1.2.5',
				'criterion': '1.2.5 Audio Description (Prerecorded) Level A'
			},
			{
				'value': '1.2.6',
				'criterion': '1.2.6 Sign Language (Prerecorded) Level AAA'
			},
			{
				'value': '1.2.7',
				'criterion': '1.2.7 Extended Audio Description (Prerecorded)  Level AAA'
			},
			{
				'value': '1.2.8',
				'criterion': '1.2.8 Media Alternative (Prerecorded)  Level AAA'
			},
			{
				'value': '1.2.9',
				'criterion': '1.2.9 Audio-only (Live)  Level AAA'
			},
			{
				'value': '1.3',
				'criterion': '1.3   Create content that can be presented in different ways (for example simpler layout) without losing information or structure'
			},
			{
				'value': '1.3.1',
			...
			{
				'value': '1.4',
				'criterion': '1.4   Make it easier for users to see and hear content including separating foreground from background'
			},
			{
				'value': '1.4.1',
			...
			{
				'value': '1.4.7',
				'criterion': '1.4.7 Low or No Background Audio  Level AAA'
			},
			{
				'value': '1.4.8',
			...
			{
				'value': '1.4.9',
				'criterion': '1.4.9 Images of Text (No Exception)  Level AAA'
			},
			{
				'value': '2.1',
				'criterion': '2.1   Make all functionality available from a keyboard'
			},
			{
				'value': '2.1.1',
			...
			{
				'value': '2.2',
				'criterion': '2.2   Provide users enough time to read and use content'
			},
			{
				'value': '2.2.1',
			...
			{
				'value': '2.2.3',
				'criterion': '2.2.3 No Timing  Level AAA'
			},
			{
				'value': '2.2.4',
				'criterion': '2.2.4 Interruptions  Level AAA'
			},
			{
				'value': '2.2.5',
				'criterion': '2.2.5 Re-authenticating  Level AAA'
			},
			{
				'value': '2.3',
				'criterion': '2.3   Do not design content in a way that is known to cause seizures'
			},
			{
				'value': '2.3.1',
				'criterion': '2.3.1 Three Flashes or Below Threshold (Seizures)  Level A'
			},
			{
				'value': '2.3.2',
				'criterion': '2.3.2 Three Flashes (Seizures)  Level AAA'
			},
			{
				'value': '2.4',
				'criterion': '2.4   Provide ways to help users navigate, find content, and determine where they are'
			},
			{
				'value': '2.4.1',
			...
			{
				'value': '2.4.6',
				'criterion': '2.4.6 Headings or Labels  Level AA'
			},
			{
				'value': '2.4.7',
			...
			{
				'value': '2.4.8',
				'criterion': '2.4.8 Location  Level AAA'
			},
			{
				'value': '2.4.9',
				'criterion': '2.4.9 Link Purpose (Link Only) Level AAA'
			},
			{
				'value': '2.4.10',
			...
			{
				'value': '3.1',
				'criterion': '3.1   Make text content readable and understandable'
			},
			{
				'value': '3.1.1',
			...
			{
				'value': '3.1.6',
				'criterion': '3.1.6 Pronunciation  Level AAA'
			},
			{
				'value': '3.2',
				'criterion': '3.2   Make Web pages appear and operate in predictable ways'
			},
			{
				'value': '3.2.1',
			...
			{
				'value': '3.3',
				'criterion': '3.3   Help users avoid and correct mistakes'
			},
			{
				'value': '3.3.1',
			...
			{
				'value': '3.3.6',
				'criterion': '3.3.6 Error Prevention (All)  Level AAA'
			},
			{
				'value': '4.1',
				'criterion': '4.1   Maximize compatibility with current and future user agents, including assistive technologies'
			},
			{
				'value': '4.1.1',
