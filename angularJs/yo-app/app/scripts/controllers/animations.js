 ...
 // animated directives
 app.controller( 'animatedDirectives', function ( $scope ) {
 ...
 app.controller( "animateService", [ '$scope', '$animate', '$q', function ( $scope, $animate, $q ) {
 	...
 	$scope.onAddSquareClick = function ( addAsSibling ) {
 		...
 		if ( box1Parent !== null ) {
 			...
 			$animate.enter( box1, ( addAsSibling ? null : box1Parent ), ( addAsSibling ? box1Parent : null ) )
 				.then( function () {
 	...
 	$scope.onAddClassClick = function () {
 		...
 		if ( box2 !== null ) {
 			...
 			$animate.addClass( box2, "custom-class" )
 				.then( function () {
 					// NOTE: I must use $scope.$apply() inside this callback
 					$scope.$apply( function () {
 	...
 	$scope.onRemoveClassClick = function () {
 		...
 		if ( box2 !== null ) {
 			...
 			$animate.removeClass( box2, "custom-class" )
 				.then( function () {
 					// NOTE: I must use $scope.$apply() inside this callback
 					$scope.$apply( function () {
 	...
 	$scope.onSetClassClick = function () {
 		...
 		if ( box3 !== null ) {
 			...
 			$animate.setClass( box3, ( setClassFlag ? "box-border" : "box-fill" ), ( setClassFlag ? "box-fill" : "box-border" ) )
 				.then( function () {
 					// NOTE: I must use $scope.$apply() inside this callback
 					$scope.$apply( function () {
